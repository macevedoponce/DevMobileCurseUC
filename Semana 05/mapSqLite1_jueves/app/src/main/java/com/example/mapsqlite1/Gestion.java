...
import com.example.mapsqlite1.databinding.ActivityGestionBinding;
...
public class Gestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarGestion.fab.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery, R.id.nav_slideshow, R.id.nav_insertarUsuario, R.id.nav_consultarUsuario, R.id.nav_listarUsuario, R.id.nav_listarUsuarioSpinner)
